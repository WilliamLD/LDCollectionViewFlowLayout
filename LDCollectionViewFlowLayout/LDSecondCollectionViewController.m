//
//  LDSecondCollectionViewController.m
...
#import "LDSecondCollectionViewController.h"
#import "LDCollectionViewFlowLayout.h"

@interface LDSecondCollectionViewController () <UICollectionViewDelegateFlowLayout>

@end

@implementation LDSecondCollectionViewController
...
#define itemsInSection @[@1, @3, @4, @20]
...
- (CGSize)collectionView:(UICollectionView *)collectionView layout:(UICollectionViewLayout*)collectionViewLayout sizeForItemAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    return CGSizeMake((self.collectionView.bounds.size.width-30)/2, 80 + 2 * indexPath.item);
}
